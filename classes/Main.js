class Main {
  ...
  calculerScore() {
    ...
    this.listCartes.forEach((carte) => {
      if (typeof carte.figure === "number")
        score +=
          carte.figure; //Si la figure est de type number, recupère le nombre pour calculer score
      else if (carte.figure === "As") {
        //Valeur de 1 ou 10 en fonction de la valeur de la main
